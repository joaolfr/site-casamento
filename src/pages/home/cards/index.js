...
import ChurchIcon from '../../../static/icons/IGREJA.png'
import CameraIcon from '../../../static/icons/CAMERA.png'
import Reception from '../../../static/icons/RECEPCAO.png'
import Suit from '../../../static/icons/TRAJE.png'
import './styles.css'
  ...
  render() {
    return(
        <div className="div_cards">
          ...
          <p>
          Esperamos que esse dia seja tão maravilhoso quanto a 
          gente sonhou e as coisas vão acontecer da seguinte forma:
          </p>
            ...
            <Grid item xs={12} md={6} id="item_cards">
              ...
              <div id="card_2">
                ...
                <div id="info_suit">
                  ...
                  <span id="suit_tips">
                  Estamos ao ar livre e no Ceará, então nada melhor 
                  do que uma roupa leve e confortável, lá contamos com 
                  grama também e talvez seja legal a mulherada 
                  apostar no salto grosso.
                  </span>
              ...
              <div id="card_2">
                <div id="uber">
                  ...
                  <span> O Uber da igreja para o buffet pode variar de R$15,00 a R$21,00</span>
                  <button>
                    <a href="https://github.io">Pedir Uber</a>
                  </button>
                  <span>Basta clicar no botão para pedir o seu Uber de onde você estiver para a recepção</span>
